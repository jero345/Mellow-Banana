...
/** Floating WhatsApp badge, bottom-right of the yellow CTA band. */
export default function WhatsappButton({ className = '' }) {
  ...
  return (
    <a
      ...
      className={`group inline-grid size-14 place-items-center rounded-full bg-[#25D366] shadow-[0_6px_24px_rgb(0_0_0/0.18)] transition-transform duration-500 ease-brand hover:scale-108 ${className}`}
    >
      <svg viewBox="0 0 24 24" className="size-8 text-white" fill="currentColor" aria-hidden="true">
